...
# https://salsa.debian.org/postgresql/postgresql-common/blob/997d842ee744687d99a2b2d95c1083a2615c79e8/debian/postgresql-common.postinst#L32-35
	useradd -r -g postgres --uid=999 --home-dir=/var/lib/mysqld --shell=/bin/bash mysql; \
# also create the postgres user's home directory with appropriate permissions
# see https://github.com/docker-library/postgres/issues/274
	mkdir -p /var/lib/mysqld; \
	chown -R postgres:postgres /var/lib/mysqld
RUN mkdir -p /var/run/mysqld && chown -R postgres:postgres /var/run/mysqld && chmod 2777 /var/run/mysqld
